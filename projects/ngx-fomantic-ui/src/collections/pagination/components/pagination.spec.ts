...
import {FuiPagination} from './pagination';
import {FuiPaginationModule} from '../pagination.module';
...
describe('Pagination', () => {
  ...
  let pagination: FuiPagination;
  let paginationElement: DebugElement;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [FuiPaginationModule],
    ...
    paginationElement = fixture.debugElement.query(By.css('fui-pagination'));
