...
<div class="ui form">
    ...
    <div class="field">
        ...
        <fui-select class="selection" [(ngModel)]="mode" [options]="datepickerModes" #modes>
            <fui-select-option *ngFor="let m of modes.availableOptions" [value]="m"></fui-select-option>
        </fui-select>
    </div>
    <div class="field">
...
<button class="ui button" fuiDatepicker>Select Date</button>
`;
...
<div class="ui form">
    <div class="field">
        ...
        <div class="ui left icon input">
            <i class="calendar icon"></i>
            <input fuiDatepicker [(ngModel)]="min" [pickerUseNativeOnMobile]="false">
        </div>
    </div>
    <div class="field">
        ...
        <div class="ui left icon input">
            <i class="calendar icon"></i>
            <input fuiDatepicker [(ngModel)]="max" [pickerUseNativeOnMobile]="false">
        </div>
    </div>
    <div class="field">
