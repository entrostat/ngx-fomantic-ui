...
<div class="field">
    ...
    <fui-select class="selection" [(ngModel)]="size" [options]="availableSizes" #sizes>
        <fui-select-option *ngFor="let s of sizes.availableOptions" [value]="s"></fui-select-option>
    </fui-select>
</div>
...
export class ModalPage {
    ...
    public autoCode = `
<fui-modal [isClosable]="true" (dismissed)="alert($event)" #modal>
    <div class="header">Example</div>
    <div class="content">
        <p>Modal content</p>
    </div>
...
import {FuiModal, ComponentModalConfig, ModalSize} from "ngx-fomantic-ui"
