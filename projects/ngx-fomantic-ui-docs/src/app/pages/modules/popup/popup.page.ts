...
<ng-template let-popup #popupTemplate>
    ...
    <div class="content">
        <fui-rating class="star" (click)="popup.close()"></fui-rating>
    </div>
</ng-template>
<button class="ui icon button" fuiPopup [popupTemplate]="popupTemplate" popupTrigger="outsideClick">
    <i class="star icon"></i> Rate
</button>
`;

const examplePlacementTemplate = `
<div class="ui card" fuiPopup popupText="You can customise my placement!" popupInverted [popupPlacement]="position">
    <div class="content">
...
<i class="circular heart icon link" fuiPopup popupWidth="wide"
...
<i class="circular heart icon link" fuiPopup popupWidth="very wide"
popupText="Hello. This is a very wide pop-up which allows for lots of content with additional space.
You can fit a lot of words here and the paragraphs will be pretty wide."></i>
<br/>
<br/>
<button class="ui icon button" fuiPopup popupWidth="flowing" [popupTemplate]="popupTemplate" popupTrigger="outsideClick">
    Show flowing popup
</button>
...
<i class="circular star icon link" fuiPopup popupSize="mini" popupText="Hello, this is a mini popup"></i>
<i class="circular star icon link" fuiPopup popupSize="tiny" popupText="Hello, this is a tiny popup"></i>
<i class="circular star icon link" fuiPopup popupSize="small" popupText="Hello, this is a small popup"></i>
<i class="circular star icon link" fuiPopup popupText="Hello, this is a standard popup"></i>
<i class="circular star icon link" fuiPopup popupSize="large" popupText="Hello, this is a large popup"></i>
<i class="circular star icon link" fuiPopup popupSize="huge" popupText="Hello, this is a huge popup"></i>
`;
...
<div class="ui segment" fuiPopup popupText="Manual" popupTrigger="manual" #popup="fuiPopup">
...
import {IPopup} from "ngx-fomantic-ui";
...
@Component({})
export class MyComponent {
    constructor(globalConfig:FuiPopupConfig) {
