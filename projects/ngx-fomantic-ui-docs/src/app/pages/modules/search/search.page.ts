...
<fui-search placeholder="Example Search..."
            [hasIcon]="hasIcon"
            [options]="options"
            [searchDelay]="0"
            (resultSelected)="alertSelected($event)"></fui-search>

<div class="ui segment">
    <fui-checkbox [(ngModel)]="hasIcon">Has icon?</fui-checkbox>
</div>
`;

const exampleRemoteTemplate = `
<fui-search [optionsLookup]="optionsSearch"
            optionsField="title"
            (resultSelected)="last = $event"></fui-search>
...
<fui-search [options]="options"
            optionsField="title"
            [resultTemplate]="template"
            [retainSelectedResult]="false"
            (resultSelected)="alert($event.title)"></fui-search>
`;
