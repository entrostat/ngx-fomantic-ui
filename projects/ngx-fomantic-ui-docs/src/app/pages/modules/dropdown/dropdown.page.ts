...
<div class="ui primary dropdown button" fuiDropdown [(isOpen)]="isOpen" [isDisabled]="isDisabled">
...
<div class="ui primary pointing dropdown button" fuiDropdown autoClose="disabled">
...
<div class="ui secondary left pointing dropdown button" fuiDropdown autoClose="disabled">
    Right
...
<div class="ui segment">
    ...
    <div class="ui floating dropdown" fuiDropdown autoClose="outsideClick">
...
<div class="ui menu">
    <a class="item">Home</a>
    <div class="ui pointing dropdown link item" fuiDropdown>
